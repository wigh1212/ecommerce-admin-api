...
public class StoreProductOptionItemController {
    ...
    public CommonResponse create(@Valid @RequestBody StoreProductOptionItemDto.CreateRequest request) throws Exception {
    ...
    public CommonResponse update(@Valid @RequestBody StoreProductOptionItemDto.UpdateRequest request) throws Exception {
